...
from .views import addCompany,getCompany,getCompanyRoles,addCompanyRoles,device, get_user_contact,get_virtual_devices,update_virtual_device,update_biometric_device,add_biometric_device,get_biometric_device,delete_virtual_device,getCompanyGroups,addCompanyGroup,create_all_view,staff_type_view,staff_category_view,employee_report

...
// import { UserPlus, Save, Upload, X, Camera, User, UserMinus, Users } from "lucide-react";
// import { useAuth } from "@/context/AuthContext";
...
//     gender: "",
//     role_id: "",
//     group_id: "", // This should match backend field name
//     company_id: companyId,
//     password: "empsyncai123@",
//     biometric_id: "",
//     is_whatsapp: true,
...
//   // 🔄 Fetch groups whenever companyId changes
//   useEffect(() => {
//     if (!companyId) return;
...
//     // For dropdowns that should be numbers, convert empty string to empty string
//     let processedValue = value;
//     if (name === 'role_id' || name === 'company_id' || name === 'group_id') {
...
//   // Helper to get selected group name
//   const getSelectedGroupName = () => {
//     if (!formData.group_id) return null;
    
//     const selectedGroup = groups.find(g => 
//       g.id === (typeof formData.group_id === 'string' ? parseInt(formData.group_id) : formData.group_id)
//     );
    
//     return selectedGroup ? (
//       selectedGroup.group_name || selectedGroup.name || selectedGroup.short_name
//     ) : null;
//   };
...
//                 {/* Role and Group Selection in Grid */}
...
//                         value={formData.role_id}
//                         onChange={handleChange}
//                         className="w-full p-2.5 border rounded-md bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary appearance-none"
//                       >
//                         <option value="">Select Role</option>
//                         {roles.length > 0 ? (
//                           roles.map((role: any) => (
...
//                   {/* Group Dropdown - IMPORTANT: Check field name */}
//                   <div>
//                     <label className="block text-sm font-medium mb-2">Group (Optional)</label>
//                     <div className="relative">
//                       <select
//                         name="group_id" // This should match what backend expects
...
//                               {group.group_name || group.name || group.short_name || `Group ${group.id}`}
//                             </option>
//                           ))
//                         ) : (
//                           <option value="" disabled>
//                             {companyId ? "Loading groups..." : "Select a company first"}
//                           </option>
//                         )}
//                       </select>
//                       <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
...
//                       Assign employee to a specific group (optional)
//                     </p>
//                     {formData.group_id && (
//                       <p className="text-xs text-green-600 dark:text-green-400 mt-1">
//                         Selected: {selectedGroupName || `ID: ${formData.group_id}`}
//                       </p>
//                     )}
//                   </div>
//                 </div>
...
//                     Role ID: {formData.role_id || "Not selected"}
//                   </p>
//                   <p className="text-xs text-yellow-600 dark:text-yellow-400">
//                     Group ID: {formData.group_id || "Not selected"}
//                   </p>
//                   <p className="text-xs text-yellow-600 dark:text-yellow-400">
//                     Total Groups Available: {groups.length}
//                   </p>
//                 </div>
...
//                     {selectedGroupName && (
//                       <span className="ml-4">
//                         Group: <span className="font-medium text-purple-600">
//                           {selectedGroupName}
//                         </span>
//                       </span>
//                     )}

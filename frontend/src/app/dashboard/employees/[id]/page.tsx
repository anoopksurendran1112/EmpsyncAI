...
//         let groupsArray: { id: number; group_name: string }[] = [];
        
//         // Try different response structures (same as add employee page)
...
//           group: selectedGroup?.group_name || selectedGroup?.name || ""
//         });
//       }
//     }
//   };

//   // Helper to get selected group name for display
...
//         role: formData.role,
//         gender: formData.gender,
//         group: formData.group, // Use the group name
//         is_whatsapp: formData.is_whatsapp,
//         is_wfh: formData.is_wfh,
//         is_active: formData.is_active,
//         role_id: formData.role_id,
//         group_id: formData.group_id, // Send the group ID (null if "none")
//       };
...
//                     onValueChange={(val) => handleChange("gender", val === "not-specified" ? "" : val)}
//                   >
//                     <SelectTrigger>
...
//               {/* Group Select - Similar to Add Employee Page */}
//               <div className="flex items-center gap-3 p-2 rounded-lg bg-muted/50">
//                 <MapPin className="h-4 w-4 text-yellow-600" />
//                 {editMode ? (
//                   <div className="w-full">
//                     <Select
//                       value={formData.group_id ? formData.group_id.toString() : "none"}
...
//                     </p>
//                     {formData.group_id && (
//                       <p className="text-xs text-gray-500">Group ID: {formData.group_id}</p>
//                     )}
//                   </div>
//                 )}
//               </div>
...
//                 <span className="font-medium">{formData.group_id || "Not set"}</span>
//               </div>
//               <div>
//                 <span className="text-gray-500">Group Name:</span>{" "}
//                 <span className="font-medium">{formData.group || "Not set"}</span>
//               </div>
//               <div>
...
//               </div>
//               <div>
//                 <span className="text-gray-500">Selected Group:</span>{" "}
//                 <span className="font-medium text-green-600">
//                   {selectedGroupName || "None"}
//                 </span>
//               </div>
//               <div>
//                 <span className="text-gray-500">Gender Value:</span>{" "}
